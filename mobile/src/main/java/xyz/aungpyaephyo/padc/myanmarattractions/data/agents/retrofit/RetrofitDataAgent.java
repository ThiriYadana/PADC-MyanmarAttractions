...
public class RetrofitDataAgent implements AttractionDataAgent {
    ...
    private RetrofitDataAgent() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(MyanmarAttractionsConstants.ATTRACTION_BASE_URL)       // base url
                .addConverterFactory(GsonConverterFactory.create(CommonInstances.getGsonInstance()))    //convert gson response to response obj
                .client(okHttpClient)
                .build();

        theApi = retrofit.create(AttractionApi.class);      //pass interface
    }
